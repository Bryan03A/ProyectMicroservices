...
# Enable CORS to allow requests from 52.205.200.130:8080
CORS(app, origins=["http://52.205.200.130:8080"], supports_credentials=True)
...
ELASTICSEARCH_URL = "http://52.205.200.130:9200"
