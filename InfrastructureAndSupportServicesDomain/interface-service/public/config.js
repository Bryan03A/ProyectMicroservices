...
const config = {
    ...
    apiUrl: window.location.hostname === 'localhost' ? 'http://98.83.63.33:5001' : 'http://98.83.63.33:5001',
    ...
    sessionApiUrl: window.location.hostname === 'localhost' ? 'http://98.83.63.33:5004' : 'http://98.83.63.33:5004',

    // catalogApiUrl: Similar to the other URLs, this is for accessing the catalog API, adjusting based on the environment.
    catalogApiUrl: window.location.hostname === 'localhost' ? 'http://98.83.63.33:5003' : 'http://98.83.63.33:5003'
};
